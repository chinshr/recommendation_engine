namespace :recommendations do
  task :build => [:environment] do
    RecommendationEngine::Model::Logic.module_eval do
      ...
      pbar = RecommendationEngine::ProgressBar.new('Gen matrix', items.length)
      ...
      pbar = RecommendationEngine::ProgressBar.new('Gen dataset', prefs.keys.length)
